...
write.table(x$input.tree.results, "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/StratCongruenceResults/InputTreeResults.txt")
write.table(x$rand.permutations, "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/StratCongruenceResults/RandomTreeResults.txt")

# Write time-scaled trees to file:
ape::write.tree(x$input.trees[1:1000], "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/HypothesisOne/Trees/FullTreesTS.tre")
ape::write.tree(x$input.trees[1001:2000], "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/HypothesisTwo/Trees/FullTreesTS.tre")
ape::write.tree(x$input.trees[2001:3000], "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/HypothesisThree/Trees/FullTreesTS.tre")
ape::write.tree(x$input.trees[3001:4000], "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/HypothesisFour/Trees/FullTreesTS.tre")
ape::write.tree(x$input.trees[4001:5000], "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/HypothesisFive/Trees/FullTreesTS.tre")
ape::write.tree(x$input.trees[5001:6000], "~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/HypothesisSix/Trees/FullTreesTS.tre")

# Read back in data (so can run these lines again without re-doing strat congruence tests):
x <- list(input.tree.results = read.table("~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/StratCongruenceResults/InputTreeResults.txt", header = TRUE), rand.permutations = read.table("~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/StratCongruenceResults/RandomTreeResults.txt", header = TRUE))
...
pdf("~/Documents/Publications/in prep/Temnospondyl Supertree 2 - Dan/Metatree/BoxPlots/StratCongruenceMeasure.pdf", width = 12, height = 7, useDingbats = FALSE)
